...
import HistoricalTrendChart from './HistoricTrendChart'; 
...
const SentimentAnalysisPage = () => {
  ...
  const historicalSentiment = [
    { date: 'Jan 2025', positive: 58, neutral: 32, negative: 10 },
    { date: 'Feb 2025', positive: 56, neutral: 30, negative: 14 },
    { date: 'Mar 2025', positive: 53, neutral: 33, negative: 14 },
    { date: 'Apr 2025', positive: 52, neutral: 35, negative: 13 },
    { date: 'May 2025', positive: 55, neutral: 30, negative: 15 },
    { date: 'Jun 2025', positive: 60, neutral: 28, negative: 12 },
    { date: 'Jul 2025', positive: 58, neutral: 30, negative: 12 },
    { date: 'Aug 2025', positive: 62, neutral: 28, negative: 10 },
  ];
